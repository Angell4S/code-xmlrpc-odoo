...
def _create(state):
    ...
    print(state)
    if state is True:
        archive = csv.DictReader(open('C:\\Users\\angel\\OneDrive\\Escritorio\\ODOODEV\\odoo-docker-devlocal\\addons-clase\\youtube_curso_marlon\\10_cargar_datos_xml_rpc\\data.csv'))
        cont = 0
